...
Dataset includes details of PPG Bilateral debt data between India & Bangladesh/Bhutan/Sri Lanka/Maldives/Myanmar/Nepal obtained using World Bank API. Each dataset contains 5 columns: 'Year': Year of debt, 'Creditor': Creditor country code, 'Debtor': Debtor country code, 'Indicator': World Bank Indicator specifying type of data, in this case 'PPG Bilateral debt', 'Data': Amount of debt in US$.
